 ...
 *
 */
public class FastRetractDown extends Command {
    ...
    @Override
    protected void end() {
        if (Robot.elevator.safeToRetract() && Robot.elevator.getTicks() < Robot.elevator.LANCE_HEIGHT_TICKS){
