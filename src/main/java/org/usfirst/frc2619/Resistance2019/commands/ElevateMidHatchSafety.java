 ...
 *
 */
public class ElevateMidHatchSafety extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public ElevateMidHatchSafety() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        ...
        addParallel(new ElevateToXPositionMotionMagic(0.50357));//will be interupted
        addSequential(new ToLimitSwitch());
        addParallel(new FastRetractUp());//retracts ASAP
        addParallel(new HatchDown());
        addSequential(new ElevateToXPositionMotionMagic(0.50357));
