 ...
 *
 */
public class ElevateLowRocketSafety extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public ElevateLowRocketSafety() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        ...
        //addParallel(new ElevateToXPositionMotionMagic(0.32485));//will be interupted
