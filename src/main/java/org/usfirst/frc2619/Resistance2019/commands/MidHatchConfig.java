 ...
 *
 */
public class MidHatchConfig extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public MidHatchConfig() {
    ...
    //if (Robot.elevator.getTicks() > Robot.elevator.SAFETY_LIMIT_TICKS){
      //  addSequential(new ElevateToXPositionMotionMagic(0.50));
    //}
    //else{
        ...
        addSequential(new ElevateToXPositionMotionMagic(0.50));
        //addSequential(new DelayedElevateToXPosition(0.50));
