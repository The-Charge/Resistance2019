 ...
 *
 */
public class ElevateTopHatchSafety extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public ElevateTopHatchSafety() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        ...
        addParallel(new ElevateToXPositionMotionMagic(1));//will be interupted
        addSequential(new ToLimitSwitch());
        addParallel(new FastRetractUp());
