...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("GoToVisionTarget", new GoToVisionTarget());

        SmartDashboard.putNumber("VisionDistance1", 0);
        SmartDashboard.putNumber("VisionDistance2", 0);
        SmartDashboard.putNumber("VisionAngle1", 0);
        SmartDashboard.putNumber("VisionAngle2", 0);
