...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Climb: deafult", new Climb(0.5));
        ...
        SmartDashboard.putData("ClimbOn", new ClimbOn());
        SmartDashboard.putData("ResetClimber: default", new ResetClimber(5));
        SmartDashboard.putData("TestRobot", new TestRobot());
