...
public class DriveTrain extends Subsystem {
	...
	// TODO: Give this a better name (what is it "actually" doing)
    ...
    public void periodic() {
        ...
        // TODO: Call `writeDashboardValues()` here
    }
    ...
    public void MotionMagicInit(double distance, int backVelocity, int backAcceleration) {
		// TODO: Move MotionMagicDistance lower where you do the math
    	...
    	// TODO: Move 0 to a constant up top (it's the PID slot for motion magic mode)
    ...
    public boolean isAtPIDDestination() {
		// TODO: Break this up into a couple lines
		// Ideally, use placeholder variables for each "piece"
    ...
    public void initSpeedMode() {    	
		...
		// TODO: Move 1 to a constant up top (it's the PID slot for speed mode)
		// It looks like you already have one (CONSTANT_SLOT_SPEED_MODE)
	...
	// TODO: Make it clear that setSpeed is a %
    public void setSpeedPID(double setSpeed) {
		...
		// TODO: Move putNumbers that you want called constantly to writeDashboardValues
		SmartDashboard.putNumber("Current", getCurrent());
	}
	
	// TODO: Put units in method name (it's amps)
	...
	// TODO: rename this to `writeDashboardDebugValues`
	// There's 2 times you write to the smart dashbaord:
	// 1) At the start, your "default" configuration (ex: PID constants)
	// 2) Every "tick" (ie: call inside periodic())
    public void writeDashboardValues() {
    	SmartDashboard.putBoolean("Inverted",isReversed);
    	// TODO: Write more dashboard values for debugging
	}
	
	public void writePIDs(double output){
		// TODO: DRY (call writeIndivPIDS with (output,output) since it does the same thing)
