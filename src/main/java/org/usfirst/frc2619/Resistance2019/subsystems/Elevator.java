...
public class Elevator extends Subsystem {
    ...
    public void writeDashboardDebugValues() {
		...
		// TODO: Add more info (like "error" or "isSafeToElevate")
    }
    ...
    public boolean isAtPIDDestination() {
		// TODO: Split this into multiple lines (use intermediate variables)
		// TODO: Use getTicks()
		// like:
		// double error = Math.abs(getTicks() - getTarget)
		// return error < MAX_MOTION_MAGIC_DISTANCE || !safeToElevatePosition()
		// TODO: why are we using "safeToElevatePosition" here? This method should simply check PID Destination.
		// TODO: Better yet, move the error variable to a method (getPIDError())
	...
	{
		//TODO: DRY: Just call safeToElevatePosition(motor.getSelectedSensorPosition)
		// Better yet, call safeToElevatePosition(getTicks())
		if (Robot.extension.getStatus()) 
		{
			return true;
		}
	...
	// TODO: What's the difference between getTicks and getEncoder?
