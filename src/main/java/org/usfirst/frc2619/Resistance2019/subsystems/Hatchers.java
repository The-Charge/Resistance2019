...
public class Hatchers extends Subsystem {
    ...
    public void hatchersInit(){
        windowMotor.configContinuousCurrentLimit(10);
        windowMotor.configPeakCurrentLimit(15, 1);
        windowMotor.enableCurrentLimit(true);
    }
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new HoldHatchPosition());
    ...
    public void Move()
    {
        ...
        {
            windowMotor.set(ControlMode.PercentOutput, 0.7);
            isUp = true;
        }
    }
    public void HatchUp()
    ...
    public void holdHatch(boolean isup){
        if (isup){
            if (isGrabbed){
                windowMotor.set(ControlMode.PercentOutput, 0);
            }else{
                windowMotor.set(ControlMode.PercentOutput, 0.2);
            }
        }else{
            windowMotor.set(ControlMode.PercentOutput, -0.4);
        }
    }
