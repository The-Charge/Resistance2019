...
public class Robot extends TimedRobot {
    ...
    public void dashboardValues() {
        ...
        DEBUG = SmartDashboard.getBoolean("DEBUG MODE", DEBUG);
    ...
    public void dashboardDebugValues() {
        ...
        tempDouble = SmartDashboard.getNumber("BallCollect", tempDouble);
        ...
        tempDouble = SmartDashboard.getNumber("Low", tempDouble);
        if (tempDouble != elevatorBottom){
        ...
        tempDouble = SmartDashboard.getNumber("High", tempDouble);
        if (tempDouble != elevatorBottom){
