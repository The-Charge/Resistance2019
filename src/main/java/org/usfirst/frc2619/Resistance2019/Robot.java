...
public class Robot extends TimedRobot {
    ...
    public static double TurnMinSpeed = 0.25;
    // END Debug values
    ...
    public void robotInit() {
        ...
        UsbCamera camera = server.startAutomaticCapture("driverCam", 0);
    ...
    public void dashboardValues() {
        ...
        SmartDashboard.putNumber("Climber Encoder", climber.getEncoderValue());
        
        SmartDashboard.putNumber("Climber Power", climber.getOutput());
        SmartDashboard.putBoolean("Finished", climber.reached(true));
